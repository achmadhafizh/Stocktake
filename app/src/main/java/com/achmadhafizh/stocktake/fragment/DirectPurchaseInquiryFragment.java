...
public class DirectPurchaseInquiryFragment extends Fragment implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
    private static final String TAG = DirectPurchaseInquiryFragment.class.getSimpleName();
    ...
    public DirectPurchaseInquiryFragment() {
        // Required empty public constructor
    }

    public static DirectPurchaseInquiryFragment newInstance(String section) {
        DirectPurchaseInquiryFragment fragment = new DirectPurchaseInquiryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_direct_purchase_inquiry, container, false);
    }
    ...
    private void prepareListData() {
        Log.d(TAG, "Reading all Stocktake DP");
